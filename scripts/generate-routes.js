...
const baseUrl = 'https://utilitylab.dev/safe-zone-generator';

const routes = {
  default: {
    title: 'Free Safe Zone Generator - Create Crop & Margin Safe Areas',
    description: 'Generate safe zones for print design, video broadcasting, and social media. Calculate safe action areas from resolutions and output sizes instantly.',
    h1: 'Free Safe Zone Generator - Create Crop & Margin Safe Areas',
    lead: 'Generate safe zones for print design, video broadcasting, and social media. Calculate safe action areas from resolutions and output sizes instantly.',
    schemaName: 'Safe Zone Generator',
    schemaDesc: 'Generate safe zones for print design, video broadcasting, and social media. Calculate safe action areas from resolutions and output sizes instantly.',
    schemaUrl: baseUrl
  }
};
